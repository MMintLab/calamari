...
class contact_mlp_decoder(nn.Module):
    def __init__(self, dim_ft, last_activation = False):
        ...
        nn.init.kaiming_normal_(self.l6.weight, a=0.0, nonlinearity='relu', mode='fan_in')
        nn.init.kaiming_normal_(self.l6_2.weight, a=0.0, nonlinearity='relu', mode='fan_in')
